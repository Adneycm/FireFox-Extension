    ...
    details => {
        if (details.tabId !== -1) {
            ...
            browser.tabs.get(details.tabId).then(tab => {
                ...
                getCookies(details.url, tabHostname, details.tabId);
            });
        }
    },
    { urls: ["<all_urls>"] }
...
function getCookies(url, tabHostname, tabId) {
  ...
  tabsData[tabId].cookiesCount = cookieCount
